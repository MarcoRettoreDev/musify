...
export default function DeleteUserForm({ className }) {
  ...
  return (
    <section className={`space-y-6 flex flex-col ${className}`}>
      <header>
      ...
      <DangerButton
        className="font-bold !ml-auto mt-auto"
        ...
        <form onSubmit={deleteUser} className="p-6">
          ...
          <div className="mt-6 space-y-4">
            ...
            <TextInput
              ...
              className=" block md:w-3/4 w-full"
              isFocused
          ...
          <div className="mt-6 flex justify-end">
            ...
            <DangerButton className="ml-auto font-bold" processing={processing}>
              Delete Account
            </DangerButton>
          </div>
        </form>
