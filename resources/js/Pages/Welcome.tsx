  ...
  return (
    <Guest>
      ...
      <div
        ...
        className={`flex app-height flex-col justify-between items-center p-0 w-full h-full bg-center bg-no-repeat bg-cover`}
      >
        <div className="text-slate-200 w-full h-full flex flex-col justify-between md:my-8">
          ...
          <div className="flex flex-col items-center gap-8">
            <BoxLogin user={user} handleGenerateValues={handleGenerateValues} />
