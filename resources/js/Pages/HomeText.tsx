...
function HomeText({ showAboutMe, setShowAboutMe, appName, loginRef }, ref) {
  const handleClickScroll = () => {
    ...
    setTimeout(() => setShowAboutMe(!showAboutMe), 600);
  };
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        <p className="underline underline-offset-2 font-medium ">Go back</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="p-4 flex flex-col gap-2 md:gap-12 justify-evenly">
          <div>
            ...
            <p>
              Here you can see what i love to do and work on, this project was
              made only for demonstration purposes and fun myself. You can
              generate an account to test the app clicking on the{' '}
          ...
          <div>
            ...
            <p>
              My name is Marco i'm a 28 years old Fullstack web/mobile developer
              working from Argentina. I love to develop products and help people
              throught technology, started beeing a self-taught developer and
              decided to study at the university, currently at thrid year of
              Bachelor's degree in Computer Systems.
              <br />
              Feel free to contact me if you have any question or want to hire
              me.
            </p>
          </div>
        </div>
        ...
        <div className="p-4">
          <h2 className="text-white mb-2 md:mb-4">Contact</h2>
